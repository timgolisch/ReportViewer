...
namespace ReportViewer2013
{
    public partial class View : System.Web.UI.Page
    {
        ...
        private string ReportPath
        {
            get
            {
                if (ReportViewer2013.Properties.Settings.Default.ReportPath.StartsWith("/"))
                    return Server.MapPath(ReportViewer2013.Properties.Settings.Default.ReportPath);
                else if (System.IO.Directory.Exists(ReportViewer2013.Properties.Settings.Default.ReportPath))
                    return ReportViewer2013.Properties.Settings.Default.ReportPath;
                else
                    return Server.MapPath(ReportViewer2013.Properties.Settings.Default.ReportPath);
            }
            //set { }
        ...
        private string DBConnectionString
        {
            get
            {
                return ReportViewer2013.Properties.Settings.Default.DsnReport;
            }
            //set { }
        }
        #endregion

...
namespace ReportViewer
{
    ...
    public partial class View : System.Web.UI.Page
    {
        ...
        private string ReportPath
        {
            get 
            { 
                if (ReportViewer.Properties.Settings.Default.ReportPath.StartsWith("/"))
                    return Server.MapPath(ReportViewer.Properties.Settings.Default.ReportPath);
                else if (System.IO.Directory.Exists(ReportViewer.Properties.Settings.Default.ReportPath))
                    return ReportViewer.Properties.Settings.Default.ReportPath;
                else
                    return Server.MapPath(ReportViewer.Properties.Settings.Default.ReportPath);
            }
            //set { }
        ...
        private string DBConnectionString
        {
            get
            {
                return ReportViewer.Properties.Settings.Default.DsnReport;
            }
            //set { }
